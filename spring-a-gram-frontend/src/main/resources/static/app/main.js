define(function(require) {
	...
	function createItemRowForGallery(item, gallery) {
		...
		var permalink = $('<a></a>').attr('href', linkHelper.htmlUrl(item._links.self.href));
	...
	$(function() {
		...
		if (onePage) {
			onePage.href = twitter.tweetIntentWithHref(window.location.href, talk, tags);
		}
		...
		stompClient.register([
			{ route: '/topic/backend.newItem', callback: showNewItem },
			{ route: '/topic/backend.deleteItem', callback: deleteItem },
			{ route: '/topic/backend.removeItemFromGallery', callback: removeItemFromGallery },
			{ route: '/topic/backend.addItemToGallery', callback: addItemToGallery }
		]);
